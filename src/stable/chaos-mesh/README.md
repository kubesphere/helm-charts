> Forked from https://github.com/chaos-mesh/chaos-mesh/tree/master/helm/chaos-mesh
# Chaos Mesh
...
```shell
helm install <release-name> stable/chaos-mesh -n <namespace> --create-namespace
```

More follow the [install-by-helm](https://chaos-mesh.org/docs/user_guides/installation#install-by-helm) doc.
